...
def upgrade() -> None:
    ...
    products_data = [
            ...
            {
                'name': 'Малиновый торт',
                'description': 'Сочетание тончайших слоеных коржей и рулетного бисквита, каждый слой промазан '
                               'сливочно-заварным кремом с меренгой',
                'price': 1695.00,
                'category': 'Торты',
                'ingredients': ['малина', 'слоёное тесто'],
                'stock': 5
            },
        {
            'name': "'Малина в тропиках'",
            'description': 'Торт с пониженным содержанием калорий, с воздушным муссом на сгущёнке с манго и маракуйей, '
                           'щедрым слоем ароматного конфитюра из лесной малины и натуральным бисквитом',
            'price': 680.00,
            'category': 'Торты',
            'ingredients': ['малина', 'бисквит', 'манго'],
            'stock': 4
        },
            {
                'name': "'Фиеста'",
